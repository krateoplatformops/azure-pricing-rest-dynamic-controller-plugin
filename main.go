...
import (
	...
	_ "github.com/krateoplatformops/azure-pricing-rest-dynamic-controller-plugin/docs"
	"github.com/krateoplatformops/azure-pricing-rest-dynamic-controller-plugin/internal/env"
	"github.com/krateoplatformops/azure-pricing-rest-dynamic-controller-plugin/internal/handlers"
	getprices "github.com/krateoplatformops/azure-pricing-rest-dynamic-controller-plugin/internal/handlers/retail/prices"

	httpSwagger "github.com/swaggo/http-swagger"
)

var (
	serviceName = "azure-pricing-rest-dynamic-controller-plugin"
)
...
func main() {
	...
	serverStr := flag.String("server", env.String("AZURE_API", "https://prices.azure.com:443"), "Azure Pricing API URL")
	...
	mux.Handle("GET /api/retail/prices", getprices.GetPrices(opts))
